...
@token_required
@bank_edit_protected  # 🔒 Blocked when BANK_DETAILS_EDITABLE=False — no role can bypass this
def upsert_my_bank_details(current_user):
    ...
    PROTECTED: Returns HTTP 403 when FeatureFlags.BANK_DETAILS_EDITABLE is False.
    Re-enable by setting env var BANK_DETAILS_EDITABLE=true and restarting.
    """
